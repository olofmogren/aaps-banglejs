...
function showTreatmentCarbs() {
  dialogActive = true;
  lib.showNumberEntry("Carbs (g)", treatmentParams.carbs, 5, "g", true, (carbs) => {
...
function showTreatmentInsulin() {
  dialogActive = true;
  lib.showNumberEntry("Insulin (U)", treatmentParams.insulin, 0.5, "U", false, (insulin) => {
...
function showProfileSwitchPercent() {
  dialogActive = true;
  lib.showNumberEntry("Percent (%)", profileSwitchParams.percentage, 10, "%", false, (percent) => {
...
function showProfileSwitchDuration() {
  dialogActive = true;
  lib.showNumberEntry("Duration (min)", profileSwitchParams.duration, 30, "min", false, (duration) => {
